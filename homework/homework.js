...
let nuevaString = " variable string";
...
function elevar(num, exponent) {
  ...
  // Tu código:
  let devolverValor = Math.pow(num,exponent);
...
function numeroRandom() {
  ...
  let random = Math.random(numeroRandom);
  return random;
}
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
 // let nombreCombinado = `Soy  ${nombre}   ${apellido}`;
 //let nombreCombinado = `Soy ${nombre} ${apellido}`;
 let nombreCombinado =  nombre + " "+ apellido;
...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí
 let areaDelTriangulo = (altura*base)/2;
